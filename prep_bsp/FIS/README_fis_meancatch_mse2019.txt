fis_meancatch: Fishery catch data.
Capa de datos: Captura comercial media para cada región de IdSO (promedio de años).

1. Institución recolectora original (cuál institución hizo la recolección de los datos de su fuente).
- Watson, RA y Tidd, A. (2018). Código taxonómico utilizado por IdSO
http://data.imas.utas.edu.au/portal/search?uuid=ff1274e1-c0ab-411b-a8a2-5a12eb27f2c0
- Instituto Nacional de Pesca (INP) (2019). Estadísticas pesqueras de Ecuador 1981 – 2018 (INP)
http://www.institutopesca.gob.ec/estadisticas-pesqueras/
...
1. Descarga de datos históricos sobre tipo de especies y toneladas de captura de pesca nacionales.
2. Asignación de taxonomía Watson, RA y Tidd, A. (2018) a cada especie.
...
Toneladas de capturas de pesca históricas en Ecuador.

8. Observación o comentario sobre los datos.


9. Significado y explicación de las columnas que se incluyen en el archivo
https://github.com/OHI-Science/mse/blob/master/prep/FIS/fis_meancatch_mse2019.csv
