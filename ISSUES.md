...
CP | GL | Global data |
CS| GL | Global data |
CW | <span style="color:orange">**Ok**</span> | score not changed | potential issue with goal trend out of [-1,+1]. Revision (?)
ECO | <span style="color:red">**NO-Ok**</span> | | Check Section
FIS | GL | Global data| 
FP| GL | Global data |
HAB| GL | Global data |
ICO| GL | R Code problems|
LE | GL | Global data |
LIV| <span style="color:green">**Ok**</span>  | score not changed
LSP| GL | Global data |
MAR| GL | Global data |
NP| GL | Global data |
SP| GL | Global data |
SPP| <span style="color:green">**Ok**</span> | score not changed|
TR| <span style="color:red">**NO-Ok**</span> | | Check Section 
