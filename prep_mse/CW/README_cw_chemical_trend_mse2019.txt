cw_chemical_trend: Chemical pollution trend
...
1. Determinación del registro histórico de pesticidas de Ecuador en el portal de la FAO (kg/ha) para el periodo de 1990 al 2017.
2. Determinación de la superficie sembrada (ha) de todos los cultivos de Manabí y Santa Elena según la información presentada en la Encuesta de Superficie y Producción Agropecuaria Continua (ESPAC) que ejecuta el Instituto Nacional de Estadística y Censo (INEC) para el periodo 2009 - 2018.
3. Obtención del volumen (kg) de pesticidas multiplicando los valores previamente obtenidos (paso 1 y 2) por provincia y año.
...
Se debe actualizar toda la información de Pesticidas (kg/ha) en el momento de realizar otra evaluación IdSO, esto debido a que FAO actualiza los valores de los últimos cuando sube nueva información.
...
En la tercera columna se observan los valores de tendencia de contaminación química, aplicando la metodología OHI descrita en el numeral 4 y escalando entre -1 y 1.
